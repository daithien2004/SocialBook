...
export class User extends Entity<UserId> {
    ...
    static reconstitute(props: {
        ...
        return new User(
            UserId.create(props.id),
            {
                ...
                readingPreferences: props.readingPreferences ? ReadingPreferences.create(props.readingPreferences) : undefined
            },
            props.createdAt,
            props.updatedAt
        );
    ...
    updateProfile(props: {
        ...
        if (props.location !== undefined) this._props.location = props.location?.trim();
        if (props.website !== undefined) this._props.website = props.website?.trim();
    ...
    updateReadingPreferences(props: Partial<IReadingPreferences>): void {
        const current = this._props.readingPreferences || ReadingPreferences.createDefault();
