...
export class TextToSpeech extends Entity<string> {
    ...
    private constructor(id: string, props: TextToSpeechProps, createdAt?: Date, updatedAt?: Date) {
    ...
    get chapterId(): string { return this._props.chapterId; }
    get bookId(): string { return this._props.bookId; }
    get text(): string { return this._props.text; }
    get voice(): string { return this._props.voice; }
    get language(): string { return this._props.language; }
    get speed(): number { return this._props.speed; }
    get status(): TTSStatus { return this._props.status; }
    get audioUrl(): string | undefined { return this._props.audioUrl; }
    get audioFormat(): string | undefined { return this._props.audioFormat; }
    get audioDuration(): number | undefined { return this._props.audioDuration; }
    get playCount(): number { return this._props.playCount; }
    get lastPlayedAt(): Date | undefined { return this._props.lastPlayedAt; }
    get processedAt(): Date | undefined { return this._props.processedAt; }
    get errorMessage(): string | undefined { return this._props.errorMessage; }
