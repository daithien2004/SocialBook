...
export class UserAchievement extends Entity<UserAchievementId> {
    ...
    private constructor(id: UserAchievementId, props: UserAchievementProps, createdAt?: Date, updatedAt?: Date) {
    ...
    get achievementId(): AchievementId { return this._props.achievementId; }
    get progress(): number { return this._props.progress; }
    get isUnlocked(): boolean { return this._props.isUnlocked; }
    get unlockedAt(): Date | null { return this._props.unlockedAt; }
    get rewardXP(): XP { return this._props.rewardXP; }
