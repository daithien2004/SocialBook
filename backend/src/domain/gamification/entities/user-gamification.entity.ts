...
export class UserGamification extends Entity<UserGamificationId> {
    ...
    private constructor(id: UserGamificationId, props: UserGamificationProps, createdAt?: Date, updatedAt?: Date) {
    ...
    get streak(): Streak { return this._props.streak; }
    get lastReadDate(): Date | null { return this._props.lastReadDate; }
    get streakFreezeCount(): number { return this._props.streakFreezeCount; }
    get totalXP(): XP { return this._props.totalXP; }
