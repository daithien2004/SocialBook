...
import { IVectorRepository, SearchResult, IndexResult, BatchIndexResult, CollectionStats } from '../../domain/repositories/vector.repository.interface';
...
import { VectorId } from '../../domain/value-objects/vector-id.vo';
