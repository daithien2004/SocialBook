...
import { SearchQuery as AppSearchQuery } from '../../domain/models/search-query.model';
import { PaginatedSearchResult, SearchResultBook } from '../../domain/models/search-result.model';
...
import { IReviewRepository } from '@/src/modules/reviews/domain/repositories/review.repository.interface';
