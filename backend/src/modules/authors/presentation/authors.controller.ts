...
import { FilterAuthorDto } from '../application/dto/filter-author.dto';
import { AuthorResponseDto } from '../application/dto/author.response.dto';
...
import { CreateAuthorCommand } from '../application/use-cases/create-author/create-author.command';
import { UpdateAuthorCommand } from '../application/use-cases/update-author/update-author.command';
import { GetAuthorsQuery } from '../application/use-cases/get-authors/get-authors.query';
import { DeleteAuthorCommand } from '../application/use-cases/delete-author/delete-author.command';

import { CloudinaryService } from '@/src/modules/cloudinary/infrastructure/services/cloudinary.service'; // Keep for now if needed, but better to remove and use interface.
// Actually, I should import the interface.
