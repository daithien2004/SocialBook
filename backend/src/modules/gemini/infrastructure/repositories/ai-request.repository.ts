...
import { IAIRequestRepository, AIRequestFilter, PaginationOptions } from '../../domain/repositories/ai-request.repository.interface';
import { AIRequest, AIRequestType } from '../../domain/entities/ai-request.entity';
import { AIRequestId } from '../../domain/value-objects/ai-request-id.vo';
import { UserId } from '../../domain/value-objects/user-id.vo';
import { AIRequestSchema, AIRequestDocument } from '../../infrastructure/schemas/ai-request.schema';
...
export class AIRequestRepository implements IAIRequestRepository {
    constructor(@InjectModel(AIRequestSchema.name) private readonly aiRequestModel: Model<AIRequestDocument>) {}
