            ...
            <div className="container mx-auto px-4 py-8 mt-12">
                ...
                <div className="grid lg:grid-cols-3 gap-8 mb-12">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <div>
                            <h1 className="text-4xl lg:text-5xl font-bold text-foreground mb-4 text-balance">{book.title}</h1>
                            <p className="text-xl text-muted-foreground mb-4">
                                Tác giả: <span className="text-primary font-semibold">{book.author}</span>
                            </p>

                            {/* Tags */}
                            <div className="flex flex-wrap gap-2 mb-6">
                                {book.genre.map((genre) => (
                                    <Badge key={genre} variant="secondary" className="bg-primary/10 text-primary hover:bg-primary/20">
                                        {genre}
                                    </Badge>
                                ))}
                                ...
                                <Badge
                                    variant="outline"
                                    className={
                                        book.status === "Completed" ? "border-green-500 text-green-600" : "border-blue-500 text-blue-600"
                                    }
                                >
                            ...
                            <div className="mt-6">
                                <div className="flex items-center gap-4">
                                    <Button variant="ghost" size="lg" className="flex items-center gap-2 text-muted-foreground">
                    ...
                    <Card className="bg-gradient-to-br from-primary/5 to-primary/10 border-primary/20 hover:shadow-lg transition-shadow">
                        <CardContent className="p-6 text-center">
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-2xl font-bold text-foreground">{book.rating}</span>
                            </div>
                            <p className="text-sm text-muted-foreground">{book.totalRatings.toLocaleString()} đánh giá</p>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="bg-gradient-to-br from-accent/5 to-accent/10 border-accent/20 hover:shadow-lg transition-shadow">
                        <CardContent className="p-6 text-center">
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-2xl font-bold text-foreground">{(book.views / 1000000).toFixed(1)}M</span>
                            </div>
                    ...
                    <Card className="bg-gradient-to-br from-red-500/5 to-red-500/10 border-red-500/20 hover:shadow-lg transition-shadow">
                        <CardContent className="p-6 text-center">
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-2xl font-bold text-foreground">{(book.likes / 1000).toFixed(0)}K</span>
                            </div>
                    ...
                    <Card className="bg-gradient-to-br from-blue-500/5 to-blue-500/10 border-blue-500/20 hover:shadow-lg transition-shadow">
                        <CardContent className="p-6 text-center">
                            <div className="flex items-center justify-center mb-2">
                                ...
                                <span className="text-2xl font-bold text-foreground">{book.chapters}</span>
                            </div>
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            <CardContent className="p-8">
                                <div className="flex items-center justify-between mb-6">
                                    <h2 className="text-2xl font-bold text-foreground">Đánh giá từ độc giả</h2>
                    ...
                    <div className="space-y-6">
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            <CardContent className="p-6">
                                <h3 className="text-lg font-semibold text-foreground mb-4">Chi tiết sách</h3>
                                <div className="space-y-3 text-sm">
                                    ...
                                    <div className="flex justify-between">
                                        ...
                                        <span className="text-foreground">{new Date(book.publishedDate).toLocaleDateString("vi-VN")}</span>
                                    </div>
                                    <div className="flex justify-between">
                                        <span className="text-muted-foreground">Cập nhật:</span>
                                        <span className="text-foreground">{new Date(book.lastUpdated).toLocaleDateString("vi-VN")}</span>
                                    </div>
                                </div>
                            </CardContent>
                        </Card>
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            <CardContent className="p-6">
                                <h3 className="text-lg font-semibold text-foreground mb-4">Thẻ</h3>
                        ...
                        <Card className="bg-card/50 backdrop-blur-sm">
                            <CardContent className="p-6">
                                <h3 className="text-lg font-semibold text-foreground mb-4">Sách liên quan</h3>
                                                ...
                                                <div className="flex gap-3 p-3 rounded-lg hover:bg-muted/50 transition-colors">
                                                    ...
                                                    <div className="flex-1 min-w-0">
                                                        ...
                                                        <div className="flex items-center gap-1 mt-2">
                                                            ...
                                                            <span className="text-xs text-muted-foreground">{relatedBook.rating}</span>
                                                        </div>
                                                    </div>
                                                </div>
                                            </Link>
