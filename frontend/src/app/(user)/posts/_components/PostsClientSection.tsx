...
import TrendingBooksWidget from '@/features/posts/components/TrendingBooksWidget';
import TopActiveReadersWidget from '@/features/posts/components/TopActiveReadersWidget';
...
const RecommendedBooks = dynamic(
    () => import('@/features/posts/components/RecommendedBooks'),
    {
        ssr: false,
        loading: () => (
