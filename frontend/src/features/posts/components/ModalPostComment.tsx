...
import { PostBookSection } from '@/features/posts/components/PostBookSection';
import { PostImageGallery } from '@/features/posts/components/PostImageGallery';
...
export default function ModalPostComment({ postData, isOpenOverride, onCloseOverride }: ModalPostCommentProps = {}) {
    ...
    return (
        <Dialog open={isPostCommentOpen} onOpenChange={(open) => {
            if (!open) {
                if (onCloseOverride) {
                    onCloseOverride();
                } else {
                ...
                <div className={cn(
                    ...
                    <div className="flex items-center justify-between p-4 border-b border-border shrink-0">
                        <UserAvatarWithInfo
                            ...
                            displayName={post.user?.username || 'Người dùng ẩn danh'}
