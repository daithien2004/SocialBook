...
export default function AudiobookView({
    ...
    if (!ttsData || ttsData.status === 'failed') {
        return (
            <div className="flex flex-col items-center justify-center h-full text-[#666666] bg-[#F9F6F0]">
                <div className="bg-[#EAE5DC]/50 p-8 rounded-2xl text-center max-w-md">
                    ...
                    <p className="text-[#666666]">
                        Audio cho chương này chưa được tạo hoặc đã xảy ra lỗi.
    ...
    if (ttsData.status === 'pending' || ttsData.status === 'processing') {
        return (
            <div className="flex flex-col items-center justify-center h-full text-[#666666] bg-[#F9F6F0]">
                <div className="bg-[#EAE5DC]/50 p-8 rounded-2xl text-center max-w-md">
                    <Loader2 className="w-12 h-12 mx-auto mb-4 text-[#4A4A4A] animate-spin" />
                    <h3 className="text-xl font-semibold text-[#2D2D2D] mb-2">Đang tạo Audio...</h3>
                    <p className="text-[#666666]">
                        Hệ thống đang tiến hành tạo Audio bằng AI. Quá trình này sẽ mất một chút thời gian.
                        Xin vui lòng không chuyển trang...
                    </p>
                </div>
            </div>
        );
