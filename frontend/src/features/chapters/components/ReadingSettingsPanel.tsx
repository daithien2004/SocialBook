...
import { useUpdateReadingPreferences } from '@/features/users/api/users.mutations';
...
export default function ReadingSettingsPanel({ isOpen, onClose }: ReadingSettingsPanelProps) {
    ...
    const { data: userPrefs } = useQuery({
        ...userQueries.readingPreferences(),
        enabled: isAuthenticated,
    });
    const { mutateAsync: updatePrefs } = useUpdateReadingPreferences();
