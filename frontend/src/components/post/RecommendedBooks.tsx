...
export default function RecommendedBooks() {
  ...
  if (error) {
    return (
        <div className="bg-white dark:bg-[#1a1a1a] rounded-2xl shadow-sm border border-slate-100 dark:border-gray-700 p-4">
            ...
            return (
                ...
                >
                  <div className="flex gap-3">
                    {/* Cover */}
                    <div className="relative flex-shrink-0 w-20 h-28 rounded-lg overflow-hidden border border-slate-200 dark:border-gray-700 shadow-sm group-hover:shadow-md transition-shadow">
                      {book.coverUrl ? (
                          <Image
                              src={book.coverUrl}
                              alt={book.title}
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      {/* Match score (nếu có) */}
                      {rec.matchScore && (
                          <span className="inline-block mb-1.5 text-[10px] font-medium px-2 py-0.5 rounded-full bg-sky-50 dark:bg-sky-900/30 text-sky-700 dark:text-sky-300 border border-sky-200 dark:border-sky-800">
