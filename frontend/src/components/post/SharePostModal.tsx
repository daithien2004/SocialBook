          ...
          <div className="px-6 py-5">
            ...
            <div className="flex items-center justify-center gap-3 mb-6 flex-wrap">
              ...
              <FacebookShareButton url={postUrl} quote={shareTitle}>
                <div
                  className="bg-[#1877f2] hover:bg-[#166fe5] flex items-center justify-center rounded-full p-3.5 text-white transition-all duration-200 hover:scale-110 hover:shadow-lg active:scale-95 group relative"
                  title="Facebook"
                >
              ...
              <TwitterShareButton url={postUrl} title={shareTitle}>
                <div
                  className="bg-[#1da1f2] hover:bg-[#1a94da] flex items-center justify-center rounded-full p-3.5 text-white transition-all duration-200 hover:scale-110 hover:shadow-lg active:scale-95 group relative"
                  title="Twitter"
                >
              ...
              >
                <div
                  className="bg-[#e60023] hover:bg-[#d50020] flex items-center justify-center rounded-full p-3.5 text-white transition-all duration-200 hover:scale-110 hover:shadow-lg active:scale-95 group relative"
                  title="Pinterest"
                >
                  <PinterestIcon />
                </div>
              ...
              >
                <div
                  className="bg-[#35465c] hover:bg-[#2c3a4d] flex items-center justify-center rounded-full p-3.5 text-white transition-all duration-200 hover:scale-110 hover:shadow-lg active:scale-95 group relative"
                  title="Tumblr"
                >
                  <TumblrIcon />
                </div>
              ...
              >
                <div
                  className="bg-[#ea4335] hover:bg-[#d93025] flex items-center justify-center rounded-full p-3.5 text-white transition-all duration-200 hover:scale-110 hover:shadow-lg active:scale-95 group relative"
                  title="Email"
                >
