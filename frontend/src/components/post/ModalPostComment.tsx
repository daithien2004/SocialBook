              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="px-4 py-2 border-t border-slate-100 bg-white sticky bottom-0">
                      <div className="flex items-center justify-between gap-4 mb-2">
                        <div>
                          <button
                              onClick={props.handleLike}
                              className="p-1.5 rounded-full hover:bg-slate-100 transition">
                            <Heart size={20}    className={`transition-transform duration-150 group-hover:scale-110 ${
                                props.likeStatus ? 'fill-rose-500 text-rose-500' : ''
                            }`} />
                          </button>
                        ...
                        <div>
                          <p className="text-xs text-slate-500">
                            {props.likeCount ?? 0} lượt thích • {props.commentCount ?? 0} bình luận
                          </p>
                        </div>
                      </div>
