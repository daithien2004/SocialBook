          ...
          <div className="flex items-center justify-between h-full">
            ...
            <div className="flex items-center gap-3">
              {isAuthenticated && userId ? (
                  ...
                  <button
                      onClick={() => router.push("/login")} // hoặc /auth/login
                      className="group flex items-center gap-2 px-4 py-2 rounded-sm border border-gray-200 text-sm font-medium text-gray-600 hover:border-blue-200 hover:bg-blue-50 hover:text-blue-600 transition-all duration-300"
                  >
                    Đăng nhập
                  </button>
              )}
