...
const trendingStories: Story[] = [
  ...
  },
  {
    ...
    author: 'Đức Minh',
    excerpt:
      'Một cậu học sinh bình thường bước vào thế giới phép thuật đầy bí ẩn và nguy hiểm...',
  ...
  },
  {
    ...
    author: 'Văn Long',
    excerpt:
      'Hành trình của một kiếm sĩ trẻ trở thành huyền thoại trong thế giới võ lâm đầy thử thách...',
  ...
  },
  {
    ...
    author: 'Lan Anh',
    excerpt:
      'Câu chuyện về một công chúa có sức mạnh băng giá và cuộc phiêu lưu tìm kiếm bản thân...',
  ...
  },
  {
    ...
    author: 'Hoàng Nam',
    excerpt:
      'Những vụ án bí ẩn trong thành phố lớn và cuộc đấu trí giữa thám tử tài ba với tội phạm...',
...
export function TrendingStories() {
  ...
  const filteredStories =
    selectedGenre === 'Tất cả'
      ? trendingStories
      : trendingStories.filter((story) => story.genre === selectedGenre);
              ...
              <CardContent className="p-0">
                <div className="relative">
                  ...
                  <div className="absolute top-3 left-3 flex gap-2">
                    <Badge
                      className={`${
                        story.isCompleted ? 'bg-green-500' : 'bg-blue-500'
                      } text-white`}
                    >
                      {story.isCompleted
                        ? 'Hoàn thành'
