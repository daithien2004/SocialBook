...
const WorldMap: React.FC<WorldMapProps> = ({ data }) => {
    ...
    useEffect(() => {
        ...
        const getCountryData = (countryName: string) => {
            ...
            return data.find(d => d.country.toLowerCase() === normalizedName.toLowerCase());
        };
    ...
    return (
        <div ref={containerRef} className="w-full h-[400px] bg-white rounded-lg overflow-hidden relative">
            <svg
                ref={svgRef}
